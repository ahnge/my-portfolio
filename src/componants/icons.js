...
export const Mouse = () => {
  return (
    <svg
      ...
      className=" text-purple-500 cursor-pointer animate-bounce"
    >
      <path
...
export const Phone = () => {
  return (
    <svg
      ...
      viewBox="0 0 24 24"
      stroke="currentColor"
      className=" text-purple-500 inline-block w-12 mr-5"
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
...
export const Mail = () => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className="h-12 text-purple-500 w-12 inline-block mr-5"
      fill="none"
      viewBox="0 0 24 24"
      stroke="currentColor"
    >
...
export const Location = () => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className="h-12 w-12 text-purple-500 inline-block mr-5"
      fill="none"
      viewBox="0 0 24 24"
      stroke="currentColor"
    >
